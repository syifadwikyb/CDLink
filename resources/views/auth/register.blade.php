...
<body class="bg-light font-montserrat">
        ...
        <div class="container mx-auto flex justify-between items-center p-8">
            ...
            <div class="relative">
                <div class="hidden md:flex space-x-4">
                    <a href="/login"><button
                            class="rounded-3xl font-bold px-12 py-3 text-purple hover:bg-customgradient2 hover:text-light">Login</button></a>
                    <a href="/register"><button
                            class="rounded-3xl font-bold px-12 py-3 bg-customgradient2 text-light">Register</button></a>
                </div>
    ...
    <div data-aos="flip-left" data-aos-duration="1000" class="container mx-auto w-full">
        <div class="flex items-center justify-center h-screen">
            <form class="lg:p-16 md:p-10 sm:p-10 p-5 bg-customgradient2 shadow-2xl rounded-xl"
                action="{{ route('register-proses') }}" method="post">
                @csrf
                <h1 class="lg:text-5xl text-4xl font-bold leading-6 text-center text-white mb-8">Register</h1>
                ...
                <button
                    class="bg-light font-bold text-center py-3 mt-8 px-5 rounded-xl w-full hover:text-light hover:bg-dark">Login</button>
            </form>
        </div>
    </div>
</body>
